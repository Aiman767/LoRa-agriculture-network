...
void updatesJson(char* jsonBuffer){
  ...
  lengthT = String(rssi).length();
  String(rssi).toCharArray(humidity,lengthT+1);
...
void httpRequest(char* jsonBuffer) {
  ...
  char data[500] = "{\"write_api_key\":\"WVEGUMJR0DZQ1ZLN\",\"updates\":"; // Replace YOUR-CHANNEL-WRITEAPIKEY with your ThingSpeak channel write API key
  ...
  if (client.connect(server, 80)) {
    client.println("POST /channels/1586923/bulk_update.json HTTP/1.1"); // Replace YOUR-CHANNEL-ID with your ThingSpeak channel ID
